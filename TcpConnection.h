 ...
 * =》 TcpConnection 设置回调 =》 Channel =》 Poller =》 Channel的回调函数
*/
...
private: 
        ...
        WriteCompleteCallback writeCompleteCallback_; // 数据发送完毕时的回调
        HighWaterMarkCallback highWaterMarkCallback_; // 缓冲区高水位回调
